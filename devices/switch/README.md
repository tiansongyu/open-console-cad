...
14 轮设计，654 个组件、835 个实体。包含主机、左右手柄、底座、非充电握把与两套腕带。整体包络参考官方数据，局部尺寸和内部结构为近似示意。

[![模型总览](output/previews/overview.png)](https://tiansongyu.github.io/open-console-cad/?device=switch&view=assembled#viewer)
