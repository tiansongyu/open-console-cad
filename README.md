...
本项目用于 CAD 建模学习、设备结构观察和三维可视化研究。当前收录 **16 款设备、9,633 个组件与 192 页 A3 图纸**，每款设备均有独立的源码、原生模型、组件清单和验证记录。
...
<table>
  ...
  <tr>
    <td align="center" width="33%">
      <a href="https://tiansongyu.github.io/open-console-cad/?device=wii&amp;view=assembled#viewer"><img src="site/public/images/wii/hero.webp" width="206" height="160" alt="Nintendo Wii RVL-001 初代白色主机、原版遥控器与双节棍的 FreeCAD 模型"></a><br>
      <strong>Nintendo Wii</strong><br>
      <sub>RVL-001 · 初代白色</sub><br>
      <a href="https://tiansongyu.github.io/open-console-cad/?device=wii&amp;view=assembled#viewer">在线 3D</a> · <a href="devices/wii/README.md">设备说明</a> · <a href="devices/wii/output/drawings/Wii_Drawings.pdf">A3 图纸</a>
    </td>
    <td align="center" width="33%">
      <a href="https://tiansongyu.github.io/open-console-cad/?device=wiiu&amp;view=assembled#viewer"><img src="site/public/images/wiiu/hero.webp" width="206" height="160" alt="Nintendo Wii U 首发白色 Basic 主机与原版 GamePad 的 FreeCAD 模型"></a><br>
      <strong>Nintendo Wii U</strong><br>
      <sub>WUP-001 · 首发白色 Basic</sub><br>
      <a href="https://tiansongyu.github.io/open-console-cad/?device=wiiu&amp;view=assembled#viewer">在线 3D</a> · <a href="devices/wiiu/README.md">设备说明</a> · <a href="devices/wiiu/output/drawings/WiiU_Drawings.pdf">A3 图纸</a>
    </td>
    <td align="center" width="33%">
      <a href="https://tiansongyu.github.io/open-console-cad/?device=saturn&amp;view=assembled#viewer"><img src="site/public/images/saturn/hero.webp" width="206" height="160" alt="Sega Saturn 日版初代灰色主机与六键手柄的 FreeCAD 模型"></a><br>
      <strong>Sega Saturn</strong><br>
      <sub>HST-3200 · 初代日版灰色</sub><br>
      <a href="https://tiansongyu.github.io/open-console-cad/?device=saturn&amp;view=assembled#viewer">在线 3D</a> · <a href="devices/saturn/README.md">设备说明</a> · <a href="devices/saturn/output/drawings/Saturn_Drawings.pdf">A3 图纸</a>
    </td>
  </tr>
  <tr>
    <td align="center" width="33%">
      <a href="https://tiansongyu.github.io/open-console-cad/?device=ps1&amp;view=assembled#viewer"><img src="site/public/images/ps1/hero.webp" width="206" height="160" alt="初代日版 PlayStation、数字手柄与记忆卡的 FreeCAD 模型"></a><br>
      <strong>Sony PlayStation</strong><br>
      <sub>SCPH-1000 · 初代日版灰色</sub><br>
      <a href="https://tiansongyu.github.io/open-console-cad/?device=ps1&amp;view=assembled#viewer">在线 3D</a> · <a href="devices/ps1/README.md">设备说明</a> · <a href="devices/ps1/output/drawings/PlayStation_Drawings.pdf">A3 图纸</a>
    </td>
    <td width="33%"></td>
    <td width="33%"></td>
  </tr>
...
制作进度：[PlayStation 2](devices/ps2/README.md) 已完成外观、原始接口、双面主板、中框、散热、内部电源、光驱、线束及机壳固定结构，手柄和附件继续制作，完成最终验证后加入模型库。详见 [制作范围与进度](docs/CLASSIC_EXPANSION.md)。
...
已收录的十三个设备目录分别为 `switch`、`switch2`、`3ds`、`nds`、`psp`、`psv`、`steamdeck`、`gameboy`、`famicom`、`atari2600`、`megadrive`、`n64` 和 `wii`。共享工具位于 `tools/`，重建时请保留仓库结构。

经典机型的扩展进度见 [开发记录](docs/CLASSIC_EXPANSION.md)。上方模型库中的设备均提供完整模型、图册与在线预览；PlayStation 2 继续扩展。
...
| 验证范围 | 记录 |
| --- | --- |
| 十三款设备的原生几何、建模历史与交付文件 | [整库交付核对](docs/collection_delivery_audit.json) |
...
| 新增 Wii：十七种视图、原版控制器与 12 页图纸 | [交付核对](devices/wii/output/reports/completion_audit.json) · [线上预览核对](devices/wii/output/reports/live_ui_checks.json) |
