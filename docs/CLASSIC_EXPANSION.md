...
- Atari 2600: 23 source stages; complete console, two CX10 joysticks, CX30-04 paddle pair, blank cartridge, adapter and TV/GAME box. 684 components / 1,511 solids. Full source rebuild, 2,016 assembly candidates, two native files and three STEP round trips pass. CAD/STEP and rebuild source are available; 12-page drawing/native-sheet and web delivery remain pending. The measured study envelope is approximate, not a manufacturer specification.
