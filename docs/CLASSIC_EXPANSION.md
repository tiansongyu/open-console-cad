...
- Wii U WUP-001 Basic: twenty-two source stages, 707 components / 1,039 solids. Complete white Basic console, original WUP-010 GamePad and 1500 mAh battery, internal flex / power / audio / antenna wiring, WUP-002 and WUP-011 adapters, HDMI cable and stylus are built. Fresh full reconstruction, all strict BRep checks and 1,107 assembly candidates pass. Two native assemblies and three colored STEP round trips pass. Twelve Kami/native A3 sheets have fourteen dimensions; local browser checks cover sixteen views and desktop/mobile layouts. Independent review of all twelve PDF pages passes. Local delivery is complete; public deployment verification follows the release commit.
