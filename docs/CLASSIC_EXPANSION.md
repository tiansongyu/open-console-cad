...
- Wii U WUP-001 Basic: sixteen source stages and 561 components now include the rounded console, original front/rear I/O, WUP-CPU-01-inspired motherboard and MCM, three underside radios, cooling duct, slot-loading drive, and a curved WUP-010 GamePad with display, controls, NFC, radio, original battery and stylus. Strict checks on all current components and all 770 assembly candidates pass. Wiring, the two Basic-bundle AC adapters, HDMI accessories, fresh full reconstruction and final drawing/web delivery remain in progress; this device is not yet in the published catalog.
