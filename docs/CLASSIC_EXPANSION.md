...
- PlayStation SCPH-1000: model-specific firsthand teardown reviewed. First two stages provide sixteen traced components: editable upper/lower shell, circular lid, system keys, indicator and side cooling slots. New-project source rebuild and saved-native interference checks pass. Detailed internals, original digital controller, accessories and final drawing/web delivery remain in progress.
